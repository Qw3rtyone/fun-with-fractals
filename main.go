...
func init() {
	...
	// local flags
	drawCmd.Flags().IntVarP(&width, "width", "W", 900, "The width of the output image")
	drawCmd.Flags().IntVarP(&height, "height", "H", 900, "The height of the output image")
	...
	animCmd.Flags().IntVarP(&width, "width", "W", 900, "The width of the output image")
	animCmd.Flags().IntVarP(&height, "height", "H", 900, "The height of the output image")
	animCmd.Flags().IntVarP(&maxIterations, "maxIteration", "i", 100, "The maximum number of iterations to cycle the fractal")
	animCmd.Flags().IntVarP(&frameCount, "frameCount", "f", 60, "The maximum number of frames to animate")
	animCmd.Flags().Float64VarP(&scale, "scale", "s", 10, "The scale of the generated image. (level of zoom within fractal)")
